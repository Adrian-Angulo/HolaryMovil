...
class _SplashScreenState extends ConsumerState<SplashScreen> {
  ...
  Future<void> _navegarSiguiente() async {
    // Breve espera para animación del splash
    ...
    if (hasSession) {
      try {
        // Cargar perfil y registros en segundo plano
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              // Logo con Animación ZoomIn y Glow
              ZoomIn(
              ...
              // Nombre de la App con FadeInDown
              FadeInDown(
              ...
              // Indicador de carga sutil con FadeIn
              FadeIn(
